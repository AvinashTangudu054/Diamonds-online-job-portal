...
export class AuthenticationService {
  ...
  constructor(private httpClient: HttpClient, private router: Router) {
    this.registerEndPoint = 'http://ec2-54-159-100-211.compute-1.amazonaws.com:8080/auth/register';
      
    this.loginendpoint = 'http://ec2-54-159-100-211.compute-1.amazonaws.com:8080/auth/login';

    this.changePasswordEndPoint='http://ec2-54-159-100-211.compute-1.amazonaws.com:8080/auth/changePassword';

    this.updateProfileEndPoint="http://ec2-54-159-100-211.compute-1.amazonaws.com:8080/auth/update"

    this.getProfileEndPoint="http://ec2-54-159-100-211.compute-1.amazonaws.com:8080/auth/get";
